  ...
  initDB() async {
    ...
    return await openDatabase(
      ...
      onCreate: (db,version){
        ...
        db.execute('CREATE TABLE reponse(id INTEGER PRIMARY KEY, id_question INTEGER, valeur TEXT, longitude DOUBLE, latitude DOUBLE)');
...
insertReponse(Reponse reponse) async {
  final Database db = await database;

  return await db.insert('reponse',
    reponse.toMap(),
    conflictAlgorithm: ConflictAlgorithm.replace,
  );
}
